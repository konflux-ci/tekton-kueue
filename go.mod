...
// github.com/tektoncd/pipeline@v1.11.0 requires a gen-crd-api-reference-docs pseudo-version whose
// commit lives on Tekton's fork, not on github.com/ahmetb/gen-crd-api-reference-docs. Pipeline's
// own replace is not applied to consumers; mirror it here so module resolution succeeds.
